...
<div class="d-flex align-items-center gap-3 mb-4">
    ...
    <div>
        <h4 class="fw-bold mb-0" style="color:#1F3864;">Edit Item</h4>
        <p class="text-muted mb-0" style="font-size:13px;">{{ $inventory->item_code }} — {{ $inventory->name }}</p>
    </div>
</div>

<div class="content-card">
    <div class="content-card-header">
        <h6><i class="bi bi-pencil-fill me-2" style="color:#2E75B6;"></i>Update Item Information</h6>
    </div>
            ...
            <div class="row g-3">
                ...
                <div class="col-md-4">
                    ...
                    <input type="number" name="minimum_stock" class="form-control"
                           value="{{ old('minimum_stock', $inventory->minimum_stock) }}" min="0" step="0.01" required>
                </div>

                <div class="col-md-4">
                    <label class="form-label fw-semibold" style="font-size:13px;">Unit Price (৳) <span class="text-danger">*</span></label>
                    <input type="number" name="unit_price" class="form-control"
                           value="{{ old('unit_price', $inventory->unit_price) }}" min="0" step="0.01" required>
                </div>
